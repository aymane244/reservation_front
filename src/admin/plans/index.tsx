...
export default function AdminPlans(){
    ...
    useEffect(() => {
        ...
        const getPlansByActivity = async () => {
            try{
                ...
                const response = await adminAxios.post("api/admin/activity-plan/get", { id: selectedActivityId });
    ...
    useEffect(() => {
        const getPlan = async () => {
            const response = await adminAxios.post("api/admin/plan/get", { name: selectedPlanName });
